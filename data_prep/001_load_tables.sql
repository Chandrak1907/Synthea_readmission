...
/*Oracle Live labs for Manage and monitoring Autonomous Database: https://apexapps.oracle.com/pls/apex/dbpm/r/livelabs/workshop-attendee-2?p210_workshop_id=553&p210_type=2&session=117445891684673 */
...
begin
 dbms_cloud.copy_data(
    ...
    file_uri_list =>'https://objectstorage.us-ashburn-1.oraclecloud.com/n/orasenatdoracledigital01/b/Synthea/o/allergies.csv',
    format => json_object('ignoremissingcolumns' value 'true', 'removequotes' value 'true','skipheaders' value 1, 'dateformat' value 'YYYY-MM-DD','delimiter' value ',') 
 );
 end;
...
begin
 dbms_cloud.copy_data(
    table_name =>'devices',
    credential_name =>'OBJ_STORE_CRED',
    file_uri_list =>'&file_uri_base/devicess.csv',
